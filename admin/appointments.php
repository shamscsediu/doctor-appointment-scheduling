			...
			<div class="card-body">
				...
				<table class="table table-bordered">
					...
					while ($row = $qry->fetch_assoc()):
						...
						<tr>
							<td>
								<?php echo date("l M d, Y h:i A", strtotime($row['schedule'])) ?>
							</td>
							<td>
								<?php echo "DR. " . $doc_arr[$row['doctor_id']]['name'] . ', ' . $doc_arr[$row['doctor_id']]['name'] ?>
							</td>
							<td>
								<?php echo $p_arr[$row['patient_id']]['name'] ?>
							</td>
							<td>
								<?php if ($row['online'] == 1): ?>
