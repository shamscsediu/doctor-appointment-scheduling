...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<?php endif; ?>
			...
			<?php if($_SESSION['login_type'] == 2 && $payment_status == 3) :?>
			<div class="form-group">
				<label for="" class="control-label">Zoom link</label>
			...
			<div class="form-group">
				...
				<select class="browser-default custom-select" name="payment_status">
					<option value="1" <?php echo isset($payment_status) && $payment_status == 1 ? "selected" : '' ; ?>>Under Review</option>
					<option value="2" <?php echo isset($payment_status) && $payment_status == 2 ? "selected" : '' ; ?>>Rejected</option>
					<option value="3" <?php echo isset($payment_status) && $payment_status == 3 ? "selected" : '' ; ?>>confirmed</option>
				</select>
			</div>
			<?php endif; ?>
