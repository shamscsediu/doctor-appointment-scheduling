	...
	<div class="card col-lg-12">
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<div class="form-group">
					<label for="bkash" class="control-label">Bkash</label>
					<input type="text" class="form-control" id="bkash" name="bkash" value="<?php echo isset($meta['bkash']) ? $meta['bkash'] : '' ?>" required>
				</div>
				<div class="form-group">
					<label for="rocket" class="control-label">Rocket</label>
					<input type="text" class="form-control" id="rocket" name="rocket" value="<?php echo isset($meta['rocket']) ? $meta['rocket'] : '' ?>" required>
				</div>
				<div class="form-group">
					<label for="nogod" class="control-label">Nogod</label>
					<input type="text" class="form-control" id="nogod" name="nogod" value="<?php echo isset($meta['nogod']) ? $meta['nogod'] : '' ?>" required>
				</div>
				<div class="form-group">
